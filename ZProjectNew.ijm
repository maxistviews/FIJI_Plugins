macro "Z Project (New)"{
	...
	projection_type = newArray("Average Intensity","Maximum Intensity","Sum Slices","Standard Deviation","Median")
	...
	Dialog.addChoice("Projection Type:", projection_type , "Maximum Intensity")
